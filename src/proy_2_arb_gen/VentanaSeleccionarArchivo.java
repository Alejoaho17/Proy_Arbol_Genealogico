        ...
        if (selectedFile.getName().endsWith(".json")) {
            ...
            if (!this.mainClass.appController.loadHouse(nombreArchivo)) {
                JOptionPane.showMessageDialog(this,
                        "Hubo un problema con el formato del archivo json: " + nombreArchivo);
                selectedFile = null;
                pnSeleccionarArchivo.setSelectedFile(selectedFile);
                return;
            }
            try {
                this.mainClass.appController.loadTreeAndHashes();
            } catch (Exception e) {
            ...
            this.ventanaPrincipal.setJLabelTitle(this.mainClass.appController.house.fullname);
            this.ventanaPrincipal.setVisible(true);
            dispose();
            return;
        }
