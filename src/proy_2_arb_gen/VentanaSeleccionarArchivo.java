...
public class VentanaSeleccionarArchivo extends javax.swing.JFrame {
     ...
     */
    public VentanaSeleccionarArchivo(Proy_2_Arb_Gen mainClass, VentanaPrincipal ventanaPrincipal) {
        setLocationRelativeTo(ventanaPrincipal);
        this.mainClass = mainClass;
        this.ventanaPrincipal = ventanaPrincipal;
        initComponents();
        // Seleccionar el directorio por defecto
        File directorio = new File(Proy_2_Arb_Gen.DefaultDirectory);
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(pnSeleccionarArchivo, javax.swing.GroupLayout.DEFAULT_SIZE, 377, Short.MAX_VALUE)
        );
    ...
    private void pnSeleccionarArchivoActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_pnSeleccionarArchivoActionPerformed
        ...
        if (selectedFile.getName().endsWith(".json")) {
            this.mainClass.appController.reset();
            if (!this.mainClass.appController.loadHouse(nombreArchivo)) {
            ...
            this.mainClass.appController.loadTreeAndHashesUsingTreeSearch();
            this.mainClass.appController.loadTreeGraph((ITree<Lord>) this.mainClass.appController.houseTree);
            this.ventanaPrincipal.setJLabelTitle(this.mainClass.appController.getHouse().fullname);
            this.ventanaPrincipal.setVisible(true);
            dispose();
            return;
