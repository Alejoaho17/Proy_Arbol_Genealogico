...
public class Lord {
     ...
     * Utilizado en Tree.buscarHijo y en Tree.buscar. Y se usan para obtener
     * el campo por el cual se está haciendo una comparación.
     * Como el comparador utiliza dos objetos Lord (a y b), se debe crear un
     * objeto Lord dummy, al cual se le asigna el campo que se quiere comparar.
     * y de esta forma el comparador haga su trabajo.
     */
    ...
    /**
     * Comparador por uniqueName comenzando por el string dado
     */
    public static IComparador<Lord> comparadorUnicoNombreComienzaPor = (Lord a, Lord b) -> {
    ...
    /**
     * Comparador por alias comenzando por el string dado
     */
    public static IComparador<Lord> comparadorAliasComienzaPor = (Lord a, Lord b) -> {
        if (a.alias == null && b.alias == null) {
            return -1;
        }
        String alias1 = (a.alias == null) ? "" : a.alias.toLowerCase();
    ...
    /**
     * Comparador por títulos comenzando por el string dado
     */
    public static IComparador<Lord> comparadorTitleComienzaPor = (Lord a, Lord b) -> {
        if (a.title == null && b.title == null) {
            return -1;
        }
        String title1 = (a.title == null) ? "" : a.title.toLowerCase();
